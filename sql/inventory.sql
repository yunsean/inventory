...
-- ----------------------------
-- Table structure for stock_barcode
-- ----------------------------
DROP TABLE IF EXISTS `stock_barcode`;
CREATE TABLE `stock_barcode` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `barcode` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `detail` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `latest_query` datetime NOT NULL,
...
CREATE TABLE `stock_goods` (
  ...
  `spell` varchar(1024) DEFAULT NULL,
  `initial` varchar(128) DEFAULT NULL,
  `trade_mark` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `manu_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `inputted` int NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Table structure for stock_intend_item
-- ----------------------------
DROP TABLE IF EXISTS `stock_intend_item`;
CREATE TABLE `stock_intend_item` (
  `tenant_id` bigint NOT NULL,
  `user_id` bigint NOT NULL,
  `goods_id` bigint NOT NULL,
  `operate` enum('INPUT','OUTPUT') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `count` int NOT NULL DEFAULT '1',
  `add_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`tenant_id`,`user_id`,`operate`,`goods_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `stock_transaction` (
  ...
  `tenant_id` bigint NOT NULL,
  `user_id` bigint NOT NULL,
  `status` enum('pending','affirmed') DEFAULT NULL,
  `operate` enum('INPUT','OUTPUT') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `remark` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `total_count` int NOT NULL DEFAULT '0',
  `kind_count` int NOT NULL DEFAULT '0',
  `add_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for stock_transaction_item
-- ----------------------------
DROP TABLE IF EXISTS `stock_transaction_item`;
CREATE TABLE `stock_transaction_item` (
  `transaction_id` bigint NOT NULL,
  `goods_id` bigint NOT NULL,
  `count` int NOT NULL,
  PRIMARY KEY (`transaction_id`,`goods_id`) USING BTREE,
